...
public:
    ...
    using NewMessageHandler = std::function<
        boost::asio::awaitable<void>(domain::ChatId chat,
    ...
    using CallbackQueryHandler = std::function<
        boost::asio::awaitable<void>(domain::ChatId chat,
                                     domain::UserId sender,
                                     domain::MessageId msg_id,
    ...
    using FileUpdateHandler = std::function<
        void(domain::FileId file_id,
             std::int64_t total,
