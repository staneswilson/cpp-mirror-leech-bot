...
public:
    ...
    [[nodiscard]] virtual boost::asio::awaitable<core::Result<std::optional<RssFeed>>>
    find(std::int64_t feed_id) = 0;
    ...
    [[nodiscard]] virtual boost::asio::awaitable<core::Result<RssFeed>>
    save(RssFeed feed) = 0;
