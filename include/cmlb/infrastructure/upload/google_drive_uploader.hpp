...
public:
    ...
    [[nodiscard]] std::string_view name() const noexcept override { return "gdrive"; }
    ...
    copy(std::string source_id, std::string target_folder_id);
    ...
    [[nodiscard]] boost::asio::awaitable<cmlb::core::Result<CountResult>>
    count(std::string folder_id);
...
private:
    ...
    [[nodiscard]] boost::asio::awaitable<cmlb::core::Result<DriveAccessToken>>
    mint_bearer();
    ...
    [[nodiscard]] boost::asio::awaitable<cmlb::core::Result<UploadResult>>
    upload_multipart(std::filesystem::path path,
    ...
    [[nodiscard]] boost::asio::awaitable<cmlb::core::Result<UploadResult>>
    upload_resumable(std::filesystem::path path,
                     const std::string& parent_folder,
                     UploadProgressHandler on_progress);
    ...
    /// returns its id.
    [[nodiscard]] boost::asio::awaitable<cmlb::core::Result<std::string>>
    create_folder(std::string name, std::string parent);
