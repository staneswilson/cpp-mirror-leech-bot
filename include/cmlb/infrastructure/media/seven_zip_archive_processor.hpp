...
public:
    ...
    boost::asio::awaitable<cmlb::core::Result<std::vector<std::filesystem::path>>>
    ...
    boost::asio::awaitable<cmlb::core::Result<std::vector<std::string>>>
        list_contents(std::filesystem::path archive,
                      std::optional<std::string> password) override;
