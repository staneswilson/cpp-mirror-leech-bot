...
public:
    ...
    [[nodiscard]] static std::string render_help(
    ...
    [[nodiscard]] static std::string render_error(
    ...
    [[nodiscard]] static std::string truncate_for_display(
