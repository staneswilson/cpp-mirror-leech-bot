...
class StubMessenger final
    : public cmlb::infrastructure::telegram::MessengerInterface {
public:
    struct HtmlSend {
    ...
    // ---- MessengerInterface -------------------------------------------
    boost::asio::awaitable<cmlb::core::Result<cmlb::domain::MessageId>>
    send_html(cmlb::domain::ChatId chat, std::string html) override {
        std::lock_guard lk{mutex_};
    ...
    edit_html(cmlb::domain::ChatId chat,
              cmlb::domain::MessageId msg,
    ...
    boost::asio::awaitable<cmlb::core::Result<void>>
    edit_keyboard(cmlb::domain::ChatId,
    ...
    boost::asio::awaitable<cmlb::core::Result<void>>
    answer_callback(cmlb::domain::CallbackQueryId,
                    std::string,
                    bool) override {
        co_return cmlb::core::Result<void>{};
    }
    ...
    boost::asio::awaitable<cmlb::core::Result<cmlb::domain::MessageId>>
    send_file(cmlb::domain::ChatId chat,
              std::filesystem::path,
              std::string,
    ...
    boost::asio::awaitable<cmlb::core::Result<void>>
    delete_message(cmlb::domain::ChatId,
                   cmlb::domain::MessageId msg) override {
        std::lock_guard lk{mutex_};
