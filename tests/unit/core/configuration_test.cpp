    ...
    TempDir() {
        ...
        for (int attempt = 0; attempt < 16; ++attempt) {
            const auto candidate =
                std::filesystem::temp_directory_path() / ("cmlb_cfg_" + std::to_string(gen()));
            std::error_code ec;
...
void clear_cmlb_env() {
    static const char* const kVars[] = {
        ...
        "CMLB_TELEGRAM_API_HASH",
        "CMLB_TELEGRAM_BOT_TOKEN",
        "CMLB_TELEGRAM_DATABASE_DIRECTORY",
        "CMLB_TELEGRAM_OWNER_ID",
        "CMLB_TELEGRAM_SUDO_USERS",
        "CMLB_TELEGRAM_AUTHORIZED_CHATS",
        "CMLB_TELEGRAM_UPLOAD_CHUNK_SIZE_KB",
        "CMLB_TELEGRAM_DOWNLOAD_CHUNK_SIZE_KB",
        "CMLB_TELEGRAM_CONNECTION_RETRY_COUNT_MAX",
        "CMLB_TELEGRAM_PREFER_IPV6",
        "CMLB_TELEGRAM_UPLOAD_PARALLELISM",
        "CMLB_TELEGRAM_UPLOAD_FILES_PARALLELISM",
        "CMLB_ARIA2_RPC_URL",
        "CMLB_ARIA2_SECRET",
        "CMLB_ARIA2_MAX_CONCURRENT_DOWNLOADS",
        "CMLB_ARIA2_REQUEST_TIMEOUT",
        "CMLB_ARIA2_MAX_CONNECTION_PER_SERVER",
        "CMLB_ARIA2_SPLIT",
        "CMLB_ARIA2_MIN_SPLIT_SIZE",
        "CMLB_ARIA2_DISK_CACHE",
        "CMLB_ARIA2_MAX_TRIES",
        "CMLB_ARIA2_RETRY_WAIT",
        "CMLB_ARIA2_MAX_OVERALL_DOWNLOAD_LIMIT",
        "CMLB_ARIA2_MAX_OVERALL_UPLOAD_LIMIT",
        "CMLB_ARIA2_ENABLE_DHT",
        "CMLB_ARIA2_ENABLE_PEX",
        "CMLB_ARIA2_BT_MAX_PEERS",
        "CMLB_ARIA2_USER_AGENT",
        "CMLB_QBITTORRENT_URL",
        "CMLB_QBITTORRENT_USERNAME",
        "CMLB_QBITTORRENT_PASSWORD",
        "CMLB_QBITTORRENT_SEED_RATIO_LIMIT",
        "CMLB_QBITTORRENT_SEED_TIME_LIMIT",
        "CMLB_QBITTORRENT_MAX_ACTIVE_DOWNLOADS",
        "CMLB_QBITTORRENT_MAX_ACTIVE_UPLOADS",
        "CMLB_QBITTORRENT_MAX_ACTIVE_TORRENTS",
        "CMLB_QBITTORRENT_MAX_CONNECTIONS",
        "CMLB_QBITTORRENT_MAX_CONNECTIONS_PER_TORRENT",
        "CMLB_QBITTORRENT_MAX_UPLOADS",
        "CMLB_QBITTORRENT_MAX_UPLOADS_PER_TORRENT",
        "CMLB_QBITTORRENT_UP_LIMIT",
        "CMLB_QBITTORRENT_DL_LIMIT",
        "CMLB_QBITTORRENT_DHT",
        "CMLB_QBITTORRENT_PEX",
        "CMLB_QBITTORRENT_LSD",
        "CMLB_QBITTORRENT_ANONYMOUS_MODE",
        "CMLB_QBITTORRENT_ASYNC_IO_THREADS",
        "CMLB_QBITTORRENT_DISK_CACHE_MIB",
        "CMLB_RCLONE_EXECUTABLE",
        "CMLB_RCLONE_CONFIG_PATH",
        "CMLB_RCLONE_TRANSFERS",
        "CMLB_RCLONE_CHECKERS",
        "CMLB_RCLONE_MULTI_THREAD_STREAMS",
        "CMLB_RCLONE_MULTI_THREAD_CUTOFF",
        "CMLB_RCLONE_DRIVE_CHUNK_SIZE",
        "CMLB_RCLONE_BUFFER_SIZE",
        "CMLB_RCLONE_USE_MMAP",
        "CMLB_RCLONE_FAST_LIST",
        "CMLB_RCLONE_DRIVE_ACKNOWLEDGE_ABUSE",
        "CMLB_RCLONE_LOG_LEVEL",
        "CMLB_GOOGLE_DRIVE_CREDENTIALS_PATH",
        "CMLB_GOOGLE_DRIVE_PARENT_FOLDER_ID",
        "CMLB_GOOGLE_DRIVE_USE_SERVICE_ACCOUNTS",
        "CMLB_GOOGLE_DRIVE_SA_FOLDER",
        "CMLB_GOOGLE_DRIVE_CHUNK_SIZE",
        "CMLB_GOOGLE_DRIVE_PARALLEL_CHUNKS_PER_FILE",
        "CMLB_GOOGLE_DRIVE_PARALLEL_FILES_PER_DIRECTORY",
        "CMLB_GOOGLE_DRIVE_MAX_RETRIES",
        "CMLB_GOOGLE_DRIVE_INITIAL_RETRY_DELAY_MS",
        "CMLB_DATABASE_PATH",
        "CMLB_DATABASE_BUSY_TIMEOUT",
        "CMLB_DATABASE_WAL_MODE",
        "CMLB_LOGGING_LOGS_DIR",
        "CMLB_LOGGING_LEVEL",
        "CMLB_LOGGING_CONSOLE",
        "CMLB_PATHS_DOWNLOAD_DIR",
        "CMLB_PATHS_DATA_DIR",
    };
...
TEST_CASE("Throughput defaults are applied when JSON omits the fields",
    ...
    CHECK(cfg.google_drive.initial_retry_delay == std::chrono::milliseconds{500});
}
...
TEST_CASE("Throughput env-var overrides reach the right field",
    ...
    clear_cmlb_env();
    {
        ...
        CHECK(cfg.google_drive.initial_retry_delay == std::chrono::milliseconds{750});
    }
...
TEST_CASE("Throughput fields parse from JSON when explicitly set",
    ...
    doc["rclone"]["extra_args"] = nlohmann::json::array({"--no-traverse", "--checksum"});
    ...
    CHECK(cfg.google_drive.initial_retry_delay == std::chrono::milliseconds{200});
}
...
TEST_CASE("qbittorrent.url scheme is validated", "[core][configuration][validate]") {
    clear_cmlb_env();
...
TEST_CASE("rclone parallelism upper bounds enforced", "[core][configuration][validate]") {
    clear_cmlb_env();
    ...
    SECTION("multi_thread_streams > 64 rejected") {
        ...
        auto result = Configuration::from_json(doc);
        REQUIRE_FALSE(result.has_value());
        CHECK_THAT(result.error().message, ContainsSubstring("rclone.multi_thread_streams"));
    }
}

TEST_CASE("database.busy_timeout has a 60 s upper bound", "[core][configuration][validate]") {
    clear_cmlb_env();
    auto doc = valid_doc();
